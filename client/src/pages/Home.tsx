  ...
  return (
    <div style={{ backgroundColor: '#f4f7f6', minHeight: '100vh', color: '#1a3a5f', fontFamily: 'sans-serif', textAlign: 'center' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '-30px auto 40px', padding: '40px', background: 'white', borderRadius: '10px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
        ...
        <a 
          href="mailto:info@lojzovypaseky.life" 
          style={{ background: '#28a745', color: 'white', padding: '15px 30px', textDecoration: 'none', borderRadius: '5px', fontWeight: 'bold', display: 'inline-block', fontSize: '20px', boxShadow: '0 4px 10px rgba(0,0,0,0.2)' }}
        >
          REZERVOVAT TEĎ
        </a>
      </div>

      {/* Nový asistent s bublinami pro rychlé dotazy */}
      <FloatingChatWidget 
        suggestions={[
